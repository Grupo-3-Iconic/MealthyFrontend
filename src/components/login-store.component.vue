<template>
    ...
    <div class="container">
        <div class="card">
            <pv-card>
                <template #title>Create your store owner account</template>
                <template #content>
                    ...
                    <div class="formgrid grid">
                        <div class="field col">
                            <label for="firstname2">Store Name</label>
                    ...
                    <div class="form grid grid">
                        <div class="field col">
                            ...
                            <input id="firstname2" type="text" class="border-orange-400 border-solid p-3 border-round w-full" placeholder="ej. Av. La perla">
                        </div>
                        <div class="field col">
                            <label for="lastname2">Photo</label>
                            <input id="lastname2" type="text" class="border-orange-400 border-solid p-3 border-round w-full" placeholder="www.image.com">
                        </div>
                    </div>
                    <div class="formgrid grid border-orange-400">
                        <div class="field col border-orange-400">
                            ...
                            <i class="fa fa-eye" v-show="showPassword" @click="showPassword = false"></i>
                            <i class="fa fa-eye-slash" v-show="!showPassword" @click="showPassword = true"></i>
                        </div>
                        <div class="field col">
